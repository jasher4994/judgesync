...
from .types import EvaluationItem, ScoreRange, AlignmentResults
...
class AlignmentTracker:
    ...
    def run_judge(self, items: Optional[List[EvaluationItem]] = None) -> List[EvaluationItem]:
